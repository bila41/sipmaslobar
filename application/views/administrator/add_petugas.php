<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftarkan Petugas Baru</li>
        </ol>
    </nav>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="">
                                         <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="status" name="nama" placeholder="Jabatan" value="<?= set_value('status'); ?>">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="id_kategori" name="id_kategori" placeholder="ID Jabatan" value="<?= set_value('id_kategori'); ?>">
                                        </div>
                                        <div class="form-group">
