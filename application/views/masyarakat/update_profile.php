                        ...
                        <div class="col-lg">
                            <div class="p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="alamat" name="alamat" placeholder="Alamat Lengkap" value="<?= $user['alamat']; ?>">
                                        <?= form_error('alamat', '<small class="pl-3 text-danger">', '</small>'); ?>
                                    </div>
                                    <!-- <div class="form-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="gamabar" name="gamabar">
                                            <label class="custom-file-label" for="gambar">Ubah Gambar</label>
                                        </div>
                                    </div> -->
                                    <button type="submit" href="<?= base_url('masyarakat/update_profile'); ?>" class="btn btn-dark btn-user btn-block">
                                        Ubah Profile
                                    </button>
                                </form>
                            </div>
